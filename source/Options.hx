...
class ComboBreakOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.missDisplay = !FlxG.save.data.missDisplay;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Combo Breaks " + (!FlxG.save.data.missDisplay ? "off" : "on");
	}
}
...
class ScoreOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.scoreDisplay = !FlxG.save.data.scoreDisplay;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Score Display " + (!FlxG.save.data.scoreDisplay ? "off" : "on");
	}
}
...
class Colour extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Colored HP Bars " + (!FlxG.save.data.colour ? "off" : "on");
	}
}
